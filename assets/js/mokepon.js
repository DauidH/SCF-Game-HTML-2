...
let gatungFuEnemigo = new Mokepon("Gatung Fu", "gatung-fu", "./assets/imgs/Personajes/Gatung-Fu-2.0/gatung-fu-blank-animated-unscreen-mirror.gif", 5, "./assets/imgs/Personajes/Gatung-Fu-2.0/gatung-fu-face-arma.png", "⚔️", ((anchoDelMapa * 390) / 570), ((alturaQueBuscamos * 35) / (427.5)))
let sheriffCatEnemigo = new Mokepon("Sheriff Cat", "sheriff-cat", "./assets/imgs/Personajes/Sheriff-Cat-2.0/sheriff-cat-blank-animated-unscreen.gif", 5, "./assets/imgs/Personajes/Sheriff-Cat-2.0/sheriff-cat-face.png", "💥", ((anchoDelMapa * 85) / 570), ((alturaQueBuscamos * 25) / (427.5)))
let catSparrowEnemigo = new Mokepon("Cat Sparrow", "cat-sparrow", "./assets/imgs/Personajes/Cat-Sparrow-2.0/cat-sparrow-animated-unscreen-mirror.gif", 5, "./assets/imgs/Personajes/Cat-Sparrow-2.0/cat-sparrow-face.png", "💀", ((anchoDelMapa * 390) / 570), ((alturaQueBuscamos * 310) / (427.5)))
let gathofenEnemigo = new Mokepon("Gathofen", "gathofen", "./assets/imgs/Personajes/Gathofen/gathofen-animated-unscreen.gif", 5, "./assets/imgs/Personajes/Gathofen/gathofen-face-arma.png", "💥💀", ((anchoDelMapa * 465) / 570), ((alturaQueBuscamos * 165) / (427.5)))
let catminatorEnemigo = new Mokepon("Catminator", "catminator", "./assets/imgs/Personajes/Catminator/catminator-animated-unscreen-mirror.gif", 5, "./assets/imgs/Personajes/Catminator/catminator-face.png", "💥⚔️", ((anchoDelMapa * 75) / 570), ((alturaQueBuscamos * 280) / (427.5)))
let catkingoEnemigo = new Mokepon("Catkingo", "catkingo", "./assets/imgs/Personajes/Catkingo-2.0/catkingo-animated-unscreen-mirror.gif", 5, "./assets/imgs/Personajes/Catkingo-2.0/catkingo-face.png", "⚔️💀", ((anchoDelMapa * 280) / 570), ((alturaQueBuscamos * 145) / (427.5)))
